...
# Cached on its arguments: while a lesson's notes are open, every rerun used to
# rebuild the PDF from scratch.
from pdf import study_notes_to_pdf as _study_notes_to_pdf  # noqa: E402

study_notes_to_pdf = st.cache_data(show_spinner=False)(_study_notes_to_pdf)
