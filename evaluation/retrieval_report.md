...
| 3 | w1d1 | Python I | 0.828 |
| 4 | w1d4 | Bonus session - Python variables and the memory model | 0.832 |
...
| Rank | Lesson | Source | Distance |
|------|--------|--------|---------:|
| 1 | w1d2 | Functions II (Returns) | 0.959 |
...
| Rank | Lesson | Source | Distance |
|------|--------|--------|---------:|
| 1 | w3d2 | Computer Vision Intro (Image Preprocessing, Filtering, and Feature Extraction) | 1.008 |
...
| Rank | Lesson | Source | Distance |
|------|--------|--------|---------:|
| 1 | w2d1 | ML demo II (Logistic Regression) | 1.237 |
...
| Rank | Lesson | Source | Distance |
|------|--------|--------|---------:|
| 1 | w2d1 | ML demo II (Logistic Regression) | 0.868 |
| 2 | w2d2 | 4_supervised_metrics_classification.ipynb | 1.022 |
| 3 | w2d1 | 2_supervised_demo_iI_logistic_reg.ipynb | 1.024 |
...
| 4 | extra | 8_langchain-agents.ipynb | 0.614 |
